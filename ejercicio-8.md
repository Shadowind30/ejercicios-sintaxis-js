...
## 6. Crear una funcion para obtener residuos y usarla para mostrar 10 residuos entre las variables numericas 
**Ejemplos:**
```javascript
...
## 26. Crear una funcion flecha para ver si un valor numerico a a es mayor a un valor numerico b
**Ejemplos:**
```javascript
